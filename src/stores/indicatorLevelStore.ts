...
const indicatorLevelStore = (storeName: 'left' | 'right') => {
    ...
    function getMinValue(type: 'count' | 'pop' | 'pct' | 'rate' | 'acres'): number | null {
        if(type === 'count') {
            ...
            return worker?.rangeValues.rate.min ?? null;
        } else if(type === 'acres') {
    ...
    function getMaxValue(type: 'count' | 'pop' | 'pct' | 'rate' | 'acres'): number | null {
        if(type === 'count') {
            ...
            return worker?.rangeValues.rate.max ?? null;
        } else if(type === 'acres') {
